 ...
 * @UniqueEntity(
 * fields={"email"},
 * message="Un autre utilisateur c'est déjà inscrit avec cette adresse mail, merci de la modifier"
 * )
 */
class User implements UserInterface
{
    ...
    //  Pas besoin d'annotation ORM car ce champ ne fait pas de lien avec la base de données
    /**
     * @Assert\EqualTo(propertyPath="hash", message="Vous n'avez pas correctement confirmé le mot de passe")
     */
