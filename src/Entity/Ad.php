...
class Ad
{
     ...
     * @Assert\Valid()
     * Le Valid sert a vérifier que les images qui sont reliées a mon annonces sont elles aussi valides
     */
    private $images;
     ...
     * L'entité gère la création du slug
     * @ORM\PrePersist
     * @ORM\PreUpdate
     * @return void
     */
    public function initializeSlug() {
        if(empty($this->slug)) { // si mon slug est vide
            $slugify = new Slugify();
            $this->slug = $slugify->slugify($this->title);
            // je fais un slug du title grace à slugify
        }
    }

    /**
     * Cette fonction permet d'obtenir un tableau des jours qui ne sont pas disponible pour cette annonce
     *
    ...
    public function getNotAvailableDays(){
        ...
        foreach ($this->bookings as $booking) {
            ...
            $resultat = range(
                ...
                24*60*60 // pour avoir les secondes d'une journée
            );

            // permet d'avoir le même tableau mais pas en timestamp mais en véritable date
