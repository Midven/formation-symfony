...
class Booking
{
     ...
     * @ORM\PrePersist
     * @ORM\PreUpdate
     * PreUpdate est pour quand j'édite une réservation dans le panneau d'administration
     * @return void
     */
    ...
    public function isBookableDates(){
        ...
        // Pareil mais avec les jours indisponibles
        $notAvailable = array_map($formatDay, $notAvailableDays);

        // pour chaque journée de ma réservation, est ce que chaque journée est différente de celles dans $notAvailable, si ce n'est pas le cas on retourne false
        foreach ($days as $day) {
            if(array_search($day, $notAvailable) !== false) return false;
        }

        // si aucune des journées ne correspond a une journée $notAvailable alors on retourne true
        return true;
